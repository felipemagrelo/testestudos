...
function updateFireIntensityPerPixel(currentPixelIndex){
    ...
    const newFireIntensity = belowPixelIntensity - decay>= 0 ?
      belowPixelIntensity - decay: 0;
...
function decreaseFireSource() {
  for (let column = 0; column <= fireWidth; column++) {
    ...
    if (currentFireIntensity > 0) {
      ...
      const newFireIntensity = currentFireIntensity- 
      decay >= 0 ? currentFireIntensity - decay : 0;
